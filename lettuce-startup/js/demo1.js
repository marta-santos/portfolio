(function() {
	var triggerBttn = document.getElementById( 'trigger-overlay' ),
		...
		overlay = document.querySelector( 'div.overlay#'+triggerBttn.id ),
...
(function() {
	...
	triggerBttnTwo = document.getElementById( 'trigger-overlay-two' ),
		...
		overlay = document.querySelector( 'div.overlay#'+triggerBttnTwo.id ),
		closeBttn = overlay.querySelector( 'button.overlay-close' );
		transEndEventNames = {
			'WebkitTransition': 'webkitTransitionEnd',
			'MozTransition': 'transitionend',
...
(function() {
	...
	triggerBttnThree = document.getElementById( 'trigger-overlay-three' ),
		...
		overlay = document.querySelector( 'div.overlay#'+triggerBttnThree.id ),
		closeBttn = overlay.querySelector( 'button.overlay-close' );
		transEndEventNames = {
			'WebkitTransition': 'webkitTransitionEnd',
			'MozTransition': 'transitionend',
...
(function() {
	...
	triggerBttnFour = document.getElementById( 'trigger-overlay-four' ),
		...
		overlay = document.querySelector( 'div.overlay#'+triggerBttnFour.id ),
		closeBttn = overlay.querySelector( 'button.overlay-close' );
		transEndEventNames = {
			'WebkitTransition': 'webkitTransitionEnd',
			'MozTransition': 'transitionend',
