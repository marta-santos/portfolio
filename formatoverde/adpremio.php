...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "adpremio")) {
  $insertSQL = sprintf("INSERT INTO premios (titulo, titulopt, tituloes, titulofr, data) VALUES (%s, %s, %s, %s, %s)",
...
<div id="main_container">
    ...
    <div class="center_content">  
     ...
     <div class="left_content">
        ...
        <h1>Adicionar Prémio</h1>
     
         <div class="form">
         <form action="<?php echo $editFormAction; ?>" method="POST" name="adpremio" enctype="multipart/form-data" onsubmit="return validar();">
         <p>Data:</p>
         ...
         <input type="hidden" name="MM_insert" value="adpremio" />
         </form>
         </div>       
