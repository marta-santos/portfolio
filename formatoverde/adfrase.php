...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "adfrase")) {
  $insertSQL = sprintf("INSERT INTO banner (titulo, subtitulo, titulopt, subtitulopt, tituloes, subtituloes, titulofr, subtitulofr) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<div id="main_container">
    ...
    <div class="left_content">
         ...
         <h1>Adicionar Frase</h1>
     
         <div class="form">
         <form action="<?php echo $editFormAction; ?>" method="POST" name="adfrase" enctype="multipart/form-data">
         <h2>Inglês</h2>
         <p>Frase:</p>
         <textarea name="titulo" cols="80"> </textarea>    
		 <p>Fonte:</p>
		 <textarea name="subtitulo" cols="80"> </textarea>
		 ...
		 <p>Fonte:</p>
		 <textarea name="subtitulopt" cols="80"> </textarea>
		 ...
		 <p>Fonte:</p>
		 <textarea name="subtituloes" cols="80"> </textarea>
		 ...
		 <p>Fonte:</p>
		 <textarea name="subtitulofr" cols="80"> </textarea>
         <input name="cod" type="hidden" value="" />
         
         <div class="sep"></div>
         
         <input name="contatos" type="submit" value="Adicionar"/>
         <input type="hidden" name="MM_insert" value="adfrase" />
         </form>
         </div>       
