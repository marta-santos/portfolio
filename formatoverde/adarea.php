...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "adarea")) {
  $insertSQL = sprintf("INSERT INTO animacoesmenu (titulo, texto, titulopt, textopt, tituloes, textoes, titulofr, textofr, data) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$target_path = "../imagens/animacoes/";
	$target_path = $target_path.mysql_insert_id().'.gif';
...
<div id="main_container">
    ...
    <div class="center_content">  
     ...
     <div class="left_content">
        ...
        <h1>Adicionar Área Temática</h1>
     
         <div class="form">
         <form action="<?php echo $editFormAction; ?>" method="POST" name="adarea" enctype="multipart/form-data" onsubmit="return validar();">
         <h2>Data:</h2>
         ...
         <input type="hidden" name="MM_insert" value="adarea" />
         </form>
         </div>           
     </div>             
  </div>           
